...
public class Dao {
	 ...
	 */
    public static ResultSet getIndicators(String indicatorsTable, String indicator) throws IOException, SQLException, ClassNotFoundException {
     ...
     * @throws ClassNotFoundException 
     */
    public static ResultSet getYears(String attributeTable, String attributeName, String targetAttribute,String values, String years ) throws IOException, SQLException, ClassNotFoundException{
	 ...
	 * @throws ClassNotFoundException 
	 */
    public static ResultSet getIndicatorsValues(String attributeTable, String attributeName, String geocode, String value, String year, String target, String targetYear) throws IOException, SQLException, ClassNotFoundException {
    ...
    public static ResultSet getGeometries (String featureTable, String featureGeocode,String featureName, String featureGeometry)
    	...
    	String sqlQuery = "SELECT "	+ featureGeocode + "," + featureName + "," + "ora2geojson.sdo2geojson('select * from " + featureTable + "', ROWID, " + featureGeometry + ") As geometry" + " from " + featureTable;
