...
public class TerracoreService {
	...
	public static ArrayList<AppPermissao> getUserPermission(int theme_id) throws IOException, SQLException, ClassNotFoundException{
	...
	public static ArrayList<AppTabela> getUserTableByThemeId(int theme_id) throws IOException, SQLException, ClassNotFoundException{
...
//	}
	...
	public static ArrayList<AppDicionarioDado> getTableAttributesDD(AppTabela tabela) throws IOException, SQLException, ClassNotFoundException{
...
//	}
	 ...
	 */
	public static ArrayList<AppTema> getThemesByKey(String key) throws IOException, SQLException, ClassNotFoundException{
	...
	public static boolean checkKey(String key) throws IOException, SQLException, ClassNotFoundException{
		boolean valid = false;
	...
	public static Acesso login(String login, String password) throws IOException, SQLException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, ClassNotFoundException{
		boolean valid = false;
	 ...
	 * @throws ClassNotFoundException 
	 */
	public static ArrayList<Endereco> execAlphaNumericLocation(String search) throws IOException, SQLException, ClassNotFoundException {
	 ...
	 * @throws ClassNotFoundException 
	 */
	public static ArrayList<Geometry> execGeoLocation(String search) throws IOException, SQLException, ClassNotFoundException {
		new TerracoreService();
		tSpatialColumn = "CAST(geom AS VARCHAR2(10))";
		...
		if (!searchText.matches("[0-9]+")) {
			...
			try {
				...
				while (rs.next()) {
					Geometry geometry = new Geometry();
					geometry.setWKT(rs.getString("CAST"));
					geom.add(geometry);
				}
